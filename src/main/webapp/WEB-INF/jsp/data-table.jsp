                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary" style="display: flex">
                                    ...
                                    <a href="data-add-form?q=${model.key}"><i class="material-icons"
                                                                              style="color: whitesmoke; font-size: 35px; border-radius: 30px; background-color: #9cd28e;">add</i></a>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table">
                                            ...
                                            <c:forEach varStatus="loop" var="m" items="${model.value}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a style="color: #5656ff;" href="data-edit-form?id=${m.id}"><i
                                                                class="material-icons">edit</i></a>
                                                        <a class="delete-data-button" data-id="${m.id}"><i
