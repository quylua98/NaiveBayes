...
<div class="wrapper ">
    ...
    <div class="main-panel">
        ...
        <!-- End Navbar -->
        <div class="content">
            <a href="data-add-form" class="btn btn-info">Thêm mới</a>
            <div class="container-fluid">
                <div class="row">
                    <c:forEach var="model" items="${modelMap}">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary" style="display: flex">
                                    <h4 class="card-title" style="flex: 1">Bảng dữ liệu - ${model.key}</h4>
                                    <a href="data-add-form?q=${model.key}"><i class="material-icons" style="color: whitesmoke; font-size: 35px; border-radius: 30px; background-color: #9cd28e;">add</i></a>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                            <c:forEach varStatus="loop" var="m" items="${model.value}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a style="color: #5656ff;" href="data-edit-form?id=${m.id}"><i class="material-icons">edit</i></a>
                                                        <a class="delete-data-button" data-id="${m.id}"><i class="material-icons">delete</i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
