                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="edit-form" action="data/" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <c:if test="${model.hocLuc != 'Trung bình'}">
                                                        <input type="radio"
                                                               name="hocLuc"
                                                               id="hocLucTB"
                                                               value="Trung bình"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <c:if test="${model.sucKhoe == 'Bình thường'}">
                                                        <input type="radio"
                                                               name="sucKhoe"
                                                               value="Bình thường"
                                                               id="sk2"
                                                ...
                                                <c:if test="${model.ngoaiHinh == 'Có'}">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio"
                                                               ...
                                                               id="nh2"
                                                               class="custom-control-input">
                                                        <label class="custom-control-label" for="nh2">Không</label>
                                                    </div>
                                                </c:if>
                                                <c:if test="${model.ngoaiHinh != 'Có'}">
                                                    <div class="custom-control custom-radio custom-control-inline">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <c:if test="${model.tinhCach == 'Hướng nội'}">
                                                <div class="form-group">
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio"
                                                               name="tinhCach"
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio"
                                                               ...
                                                               id="tc2"
                                                               class="custom-control-input">
                                                        <label class="custom-control-label" for="tc2">Hướng
                                                            ngoại</label>
                                                    </div>
                                                </div>
                                            </c:if>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <c:if test="${model.kinhTe == 'Bình thường'}">
                                                        <input type="radio"
                                                               name="kinhTe"
                                                               value="Bình thường"
                                                               id="kt1"
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <c:if test="${model.kinhTe == 'Giàu có'}">
                                                        <input type="radio"
                                                               name="kinhTe"
                                                               value="Giàu có"
                                                               id="kt2"
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <c:if test="${model.kinhTe == 'Khó khăn'}">
                                                        <input type="radio"
                                                               name="kinhTe"
                                                               value="Khó khăn"
                                                               id="kt3"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <c:if test="${model.huongNganh == 'Kĩ thuật'}">
                                                        <input type="radio"
                                                               name="huongNganh"
                                                               value="Kĩ thuật"
                                                               id="huongNganh1"
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <c:if test="${model.huongNganh == 'Kinh tế'}">
                                                        <input type="radio"
                                                               name="huongNganh"
                                                               value="Kinh tế"
                                                               id="huongNganh2"
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <c:if test="${model.huongNganh == 'Xã hội'}">
                                                        <input type="radio"
                                                               name="huongNganh"
                                                               value="Xã hội"
                                                               id="huongNganh3"
        ...
        $("#edit-form").submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    swal("Thành công!", "Dữ liệu của bạn đã được sửa.", "success");
                },
                error: function () {
